namespace Kurs
{
	partial class CashBoxForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cashBoxForm_SalePositionContainerBindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			this.cashBoxForm_SalePositionContainerDataGridView = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.cashBoxForm_SalePositionContainerBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.storeItemBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.cashBoxForm_SalePositionContainerDataGridView)).BeginInit();
			this.SuspendLayout();
			// 
			// splitContainer1
			// 
			...
			this.splitContainer1.Panel1.Controls.Add(this.storeItemDataGridView);
			this.splitContainer1.Panel1.Controls.Add(this.storeItemBindingNavigator);
			// 
			// splitContainer1.Panel2
			// 
			this.splitContainer1.Panel2.AutoScroll = true;
			this.splitContainer1.Panel2.Controls.Add(this.cashBoxForm_SalePositionContainerDataGridView);
			this.splitContainer1.Panel2.Controls.Add(this.bindingNavigator1);
			this.splitContainer1.Size = new System.Drawing.Size(807, 281);
			...
			this.storeItemDataGridView.AllowUserToDeleteRows = false;
			...
			this.storeItemDataGridView.EditMode = System.Windows.Forms.DataGridViewEditMode.EditProgrammatically;
			this.storeItemDataGridView.Location = new System.Drawing.Point(0, 25);
			this.storeItemDataGridView.MultiSelect = false;
			this.storeItemDataGridView.Name = "storeItemDataGridView";
			this.storeItemDataGridView.ReadOnly = true;
			this.storeItemDataGridView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.storeItemDataGridView.Size = new System.Drawing.Size(350, 256);
			this.storeItemDataGridView.TabIndex = 0;
			this.storeItemDataGridView.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.storeItemDataGridView_MouseDoubleClick);
			// 
			// storeItemBindingNavigator
			// 
			this.storeItemBindingNavigator.AddNewItem = null;
			...
			this.storeItemBindingNavigator.DeleteItem = null;
			...
			this.storeItemBindingNavigator.Size = new System.Drawing.Size(350, 25);
			this.storeItemBindingNavigator.TabIndex = 1;
			...
			// 
			// cashBoxForm_SalePositionContainerBindingSource
			// 
			this.cashBoxForm_SalePositionContainerBindingSource.DataSource = typeof(Kurs.CashBoxForm.SalePositionContainer);
			// 
			...
			// 
			// cashBoxForm_SalePositionContainerDataGridView
			// 
			this.cashBoxForm_SalePositionContainerDataGridView.AutoGenerateColumns = false;
			this.cashBoxForm_SalePositionContainerDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.cashBoxForm_SalePositionContainerDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.dataGridViewTextBoxColumn4,
            this.dataGridViewTextBoxColumn5,
            this.dataGridViewTextBoxColumn6,
            this.dataGridViewTextBoxColumn7});
			this.cashBoxForm_SalePositionContainerDataGridView.DataSource = this.cashBoxForm_SalePositionContainerBindingSource;
			this.cashBoxForm_SalePositionContainerDataGridView.Dock = System.Windows.Forms.DockStyle.Fill;
			this.cashBoxForm_SalePositionContainerDataGridView.Location = new System.Drawing.Point(0, 25);
			this.cashBoxForm_SalePositionContainerDataGridView.Name = "cashBoxForm_SalePositionContainerDataGridView";
			this.cashBoxForm_SalePositionContainerDataGridView.Size = new System.Drawing.Size(453, 256);
			this.cashBoxForm_SalePositionContainerDataGridView.TabIndex = 1;
			// 
			...
			this.dataGridViewTextBoxColumn6.HeaderText = "цена шт.";
			this.dataGridViewTextBoxColumn6.Name = "dataGridViewTextBoxColumn6";
			// 
			// dataGridViewTextBoxColumn7
			// 
			this.dataGridViewTextBoxColumn7.DataPropertyName = "SummPrice";
			this.dataGridViewTextBoxColumn7.HeaderText = "Сум.";
			...
			((System.ComponentModel.ISupportInitialize)(this.cashBoxForm_SalePositionContainerBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.storeItemBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.cashBoxForm_SalePositionContainerDataGridView)).EndInit();
		...
		private System.Windows.Forms.BindingSource cashBoxForm_SalePositionContainerBindingSource;
		private System.Windows.Forms.DataGridView cashBoxForm_SalePositionContainerDataGridView;
